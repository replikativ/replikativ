 ...
 (let [out (chan)
   ...
   (put! fetched-ch {:type :fetch/edn-ack
                     :values {1 {:transactions [[11 12]]
                                 :crdt-refs #{#replikativ.crdt.Repository{:commit-graph {2 []}
                                                                          :branches {"master" #{2}}}}}}})
   (put! fetched-ch {:type :fetch/edn-ack
                     :values {2 {:transactions [[21 22]]
                                 :crdt-refs #{#replikativ.crdt.Repository{:commit-graph {3 []}
                                                                          :branches {"master" #{2}}}}}}})
   (put! fetched-ch {:type :fetch/edn-ack
                     :values {3 {:transactions [[store-blob-trans-id #uuid "3dfeb3c9-e6cf-53b2-97df-bb4e77a2dda8"]]
                                 :crdt-refs #{#replikativ.crdt.Repository{:commit-graph {1 []}
                                                                          :branches {"master" #{2}}}}}}})
   (let [pub {:crdt :repo
              :op {:method :new-state
                   :commit-graph {1 []}
